...
from sqlalchemy import DateTime, ForeignKey, func, null
...
class PostDbMdl(Base):
    ...
    # props:
    channel_id: Mapped[int] = mapped_column(ForeignKey("channels.id"), nullable=False, default=null(), server_default=null())
